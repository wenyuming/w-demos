          ...
          <div class="city-wrapper city-wrapper-hook">
            <div class="scroller-hook">
              <div class="cities cities-hook">
                <div v-for="i in value">
                    ...
                    <ul>
                        <li v-for="item in i[children]" class="item city-click" :data-name="item[label]" :data-id="item[relkey]"><span class="border-1px name" @touchend="touchUp(item)"  @touchstart="chooseCity()">{{item[label]}}</span>
                        </li>
                    </ul>
                </div>
              </div>
            ...
            <div class="shortcut shortcut-hook" style="right: 50px;top:100px !important;" @touchstart="touchIndex">
                <ul style="width: 100px;text-align: left;padding: 20px 0">
                    <li v-for="i in value" :data-anchor="i[label]" class="item">{{i[label].substr(0, 1)}}</li>
                </ul>
            </div>
          </div>
        </div>
